        ...
        return this.authService.token.pipe(
            ...
            switchMap(token => {
                return this.http.get<PlaceData>(
                    `https://ionic-angular-booking-ap-f1811.firebaseio.com/offered-places/${id}.json?auth=${token}`
                );
            }),
            map(placeData => {
                return new Place(
        ...
        return this.authService.token.pipe(
            ...
            switchMap(token => {
                return this.http.get<{ [key: string]: PlaceData }>(
                    `https://ionic-angular-booking-ap-f1811.firebaseio.com/offered-places.json?auth=${token}`
                );
            }),
